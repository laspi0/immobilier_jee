    ...
    <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <a class="nav-link" href="${pageContext.request.contextPath}/allUnits">
                ...
                <a class="nav-link" href="${pageContext.request.contextPath}/locationByUser">
                ...
                <li class="nav-item w-100">
                <a class="nav-link" href="${pageContext.request.contextPath}/userPayment">
                    <i class="fa-solid fa-sack-dollar fa-2x"></i>
                    <span class="ml-3 item-text">Paiements</span>
                </a>
            </li>
