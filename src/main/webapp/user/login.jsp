...
<head>
    ...
    <!-- App CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}css/app-light.css" id="lightTheme" disabled>
    <link rel="stylesheet" href="${pageContext.request.contextPath}css/app-dark.css" id="darkTheme">
</head>
<body class="dark ">
<div class="wrapper vh-100">
    <div class="row align-items-center h-100">
        <form class="mx-auto text-center" method="post" action="${pageContext.request.contextPath}/login">
...
<script src='${pageContext.request.contextPath}js/jquery.stickOnScroll.js'></script>
<script src="${pageContext.request.contextPath}js/tinycolor-min.js"></script>
<script src="${pageContext.request.contextPath}js/config.js"></script>
<script src="${pageContext.request.contextPath}js/apps.js"></script>
